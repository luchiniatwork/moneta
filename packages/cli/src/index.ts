...
program
  ...
  .option("--agent <identity>", "Only this agent identity (omit to search all agents)")
  .option("--engineer <name>", "Only this engineer (omit to search all engineers)")
  .option("--repo <name>", "Only this repository (omit to search all repos)")
  .option("--tags <tags>", "Only memories with these tags, comma-separated")
...
program
  ...
  .option("--agent <identity>", "Only this agent identity (omit to list all agents)")
  .option("--engineer <name>", "Only this engineer (omit to list all engineers)")
  .option("--repo <name>", "Only this repository (omit to list all repos)")
  .option("--tags <tags>", "Only memories with these tags, comma-separated")
